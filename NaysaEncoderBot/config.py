...
class Config(object):
    ...
    APP_ID = int(get_config("APP_ID", 5166878))
    API_HASH = get_config("API_HASH", "fdafb41f9a67f40e34a6c67f47730a92")
...
# array , simplest method was AUTH_USERS = [] ; AUTH_USERS.append(your telegram id) 🤣
    ...
    TG_BOT_TOKEN = get_config("TG_BOT_TOKEN", "5870372680:AAENb7lbqL1oFyP2KCQRD3TJQ8Zr-ro2AE8")
    # the download location, where the HTTP Server runs
    DOWNLOAD_LOCATION = get_config("DOWNLOAD_LOCATION", "/app/downloads")
    # Telegram maximum file upload size
    BOT_USERNAME = get_config("BOT_USERNAME", "Hd10EncoderBot")
